                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><em class="fa fa-phone"></em> +2 95 01 88 821</a></li>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::to('/trang-chu')}}"><img src="{{asset('user/images/home/logo.png')}}"
                                                                 alt=""/></a>
                    </div>
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="#"><em class="fa fa-user"></em> Account</a></li>
                            <li><a href="#"><em class="fa fa-star"></em> Wishlist</a></li>
                            <li><a href="checkout.html"><em class="fa fa-crosshairs"></em> Checkout</a></li>
                            <li><a href="cart.html"><em class="fa fa-shopping-cart"></em> Cart</a></li>
                            <li><a href="login.html"><em class="fa fa-lock"></em> Login</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li class="dropdown"><a href="#">Shop<em class="fa fa-angle-down"></em></a>
                            ...
                            <li class="dropdown"><a href="#">Blog<em class="fa fa-angle-down"></em></a>
                                <ul role="menu" class="sub-menu">
                ...
                <div class="left-sidebar">
                            ...
                            <div class="panel-heading">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordian" href="#sportswear">
                                        <span class="badge pull-right"><em class="fa fa-plus"></em></span>
                                        Sportswear
                                    </a>
                                </h4>
                            </div>
                    ...
                    <div class="price-range"><!--price-range-->
                        ...
                        <div class="well text-center">
                            ...
                            <strong class="pull-left">$ 0</strong> <strong class="pull-right">$ 600</strong>
                        </div>
                    </div><!--/price-range-->
                        ...
                        <div class="video-gallery text-center">
                            <a href="#">
                                ...
                                <div class="overlay-icon">
                                    <em class="fa fa-play-circle-o"></em>
                                </div>
                            </a>
                            <p>Circle of Hands</p>
                            <h2>24 DEC 2014</h2>
                ...
                <div class="col-sm-3 col-sm-offset-1">
                    <div class="single-widget">
                        ...
                        <form action="#" class="searchform">
                            ...
                            <button type="submit" class="btn btn-default"><em class="fa fa-arrow-circle-o-right"></em>
                            </button>
